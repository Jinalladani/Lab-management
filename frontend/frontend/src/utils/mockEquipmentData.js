...
const defaultCalibrationRecords = [
  {
    ...
    makeAndModel: "AIMIL / CTM3200",
    calibrationDate: "2026-06-12",
    nextDue: "2027-06-12",
    frequency: "12 Months",
    agency: "ABC NABL Lab",
    certificateNo: "CAL-2026-001",
    productMaterial: "Concrete & Cement",
    equipmentUseForTest: "Compression Strength Testing",
    cost: 15000,
    status: "Pass",
  ...
  },
  {
    ...
    makeAndModel: "FIE / UTM1000",
    calibrationDate: "2025-07-28",
    nextDue: "2026-07-28",
    frequency: "12 Months",
    agency: "XYZ NABL Lab",
    certificateNo: "CAL-2025-178",
    productMaterial: "Steel & Rebar",
    equipmentUseForTest: "Tensile & Yield Strength Testing",
    cost: 25000,
    status: "Pass",
  ...
  },
  {
    ...
    eqCode: "EQ-OVN-003",
    eqName: "Oven 105°C",
    makeAndModel: "Tempo / OV-300",
    calibrationDate: "2025-07-05",
    nextDue: "2026-07-05",
    frequency: "12 Months",
    agency: "ABC NABL Lab",
    certificateNo: "CAL-2025-096",
    productMaterial: "Soil & Aggregates",
    equipmentUseForTest: "Moisture Content Oven Dry Test",
    cost: 4500,
    status: "Pass",
  ...
  },
  {
    ...
    makeAndModel: "Sartorius / Entris",
    calibrationDate: "2025-05-16",
    nextDue: "2026-05-16",
    frequency: "12 Months",
    agency: "XYZ NABL Lab",
    certificateNo: "CAL-2025-012",
    productMaterial: "General Laboratory",
    equipmentUseForTest: "Precision Mass Weighing",
    cost: 3200,
    status: "Pass",
  ...
  },
  {
    ...
    eqId: "EQ-005",
    eqCode: "EQ-TRX-005",
    eqName: "Triaxial Testing Machine",
    makeAndModel: "HEICO / TRX-50",
    ...
    certificateNo: "CAL-2025-334",
    productMaterial: "Soil & Aggregates",
    equipmentUseForTest: "Triaxial Shear Strength Test",
    cost: 18500,
    status: "Pass",
    remarks: "Pressure cell & LVDT calibrated. Operational bounds verified."
  },
  {
    id: "REC-006",
    eqId: "EQ-006",
    eqCode: "EQ-RING-006",
    eqName: "Proving Ring 50kN",
    makeAndModel: "AIMIL / PR-50",
    calibrationDate: "2025-07-18",
    nextDue: "2026-07-18",
    frequency: "12 Months",
    agency: "ABC NABL Lab",
    certificateNo: "CAL-2025-199",
    productMaterial: "Soil & Aggregates",
    equipmentUseForTest: "Soil Load Proving Test",
    cost: 5500,
    status: "Pass",
    remarks: "Dial gauge zero setting verified. Elasticity factor confirmed."
  },
  {
    id: "REC-007",
    eqId: "EQ-007",
    eqCode: "EQ-[#007]",
    eqName: "Slump Cone",
    makeAndModel: "CivilTech / SC-300",
    calibrationDate: "2025-08-11",
    nextDue: "2026-08-11",
    frequency: "12 Months",
    agency: "ABC NABL Lab",
    certificateNo: "CAL-2025-288",
    productMaterial: "Concrete & Cement",
    equipmentUseForTest: "Fresh Concrete Workability Test",
    cost: 2500,
    status: "Pass",
    remarks: "Physical dimensions & wall thickness verified to IS 7320."
  },
  {
    id: "REC-008",
    eqId: "EQ-008",
    eqCode: "EQ-CAL-008",
    eqName: "Digital Vernier Caliper",
    makeAndModel: "Mitutoyo / 150",
    ...
    certificateNo: "CAL-2025-339",
    productMaterial: "General Laboratory",
    equipmentUseForTest: "Dimension Precision Check",
    cost: 1800,
    status: "Pass",
    remarks: "Calibrated with master gauge blocks. Zero error within limits."
  }
];
