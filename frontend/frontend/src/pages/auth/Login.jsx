    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-3/5 bg-gradient-to-br from-[#2562AA] to-[#1e4f8a] flex-col justify-center items-center text-white p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          {/* <p className="text-xl mb-8 font-light tracking-wide">Welcome to</p> */}
          ...
          <p className="text-xl opacity-90 max-w-lg mx-auto leading-relaxed mb-8">
            Your complete laboratory management solution for streamlined operations and enhanced productivity
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2562AA] focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400"
                />
              </div>
              {errors.email && (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2562AA] focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400"
                />
                <button
                  type="button"
            ...
            <div className="text-right">
              <a
                ...
                className="text-sm text-[#2562AA] hover:text-[#1e4f8a] transition-colors duration-200"
              >
                Forgot Password?
              </a>
            </div>
