...
import { forgotPasswordRequest, forgotPasswordVerify } from "../../api";
...
const ForgotPasswordOtp = () => {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      const response = await forgotPasswordVerify(storedEmail, otp);
  ...
  const handleResend = async () => {
    try {
      setLoading(true);
      await forgotPasswordRequest(storedEmail);
      setDigits(Array(6).fill(""));
      setErrors({ otp: "", common: "A new OTP has been sent to your email." });
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-3/5 bg-gradient-to-br from-[#2562AA] to-[#1e4f8a] flex-col justify-center items-center text-white p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          {/* <p className="text-xl mb-8 font-light tracking-wide">Verify Code</p> */}
          ...
          <p className="text-xl opacity-90 max-w-lg mx-auto leading-relaxed mb-8">
            Enter the verification code sent to your email for secure access
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 lg:w-2/5 flex items-center justify-center p-6 lg:p-8 bg-white">
        <div className="w-full max-w-sm">
          ...
          <div className="w-full text-center text-sm text-gray-600 mb-6">
            ...
            OTP sent to <span className="font-bold">{storedEmail}</span>
          </div>
          ...
          <form onSubmit={handleVerify} className="space-y-5">
            ...
            <div className="flex items-center gap-2 text-gray-600 text-sm p-3 bg-blue-50 rounded-lg">
              ...
              <span>Please enter the code from your email.</span>
            </div>
